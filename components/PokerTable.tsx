...
export default function CardSelect ({}: Props) {
  ...
  return (
    <>
      <div className="mx-auto bg-white shadow-sm p-4" style={styleA}>
        <div className="bg-gray-50 h-full w-full shadow-inner p-8" style={styleB}>
          <div className="bg-gray-100 h-full w-full shadow-inner" style={styleC}>
          </div>
        </div>
      </div>
    </>
